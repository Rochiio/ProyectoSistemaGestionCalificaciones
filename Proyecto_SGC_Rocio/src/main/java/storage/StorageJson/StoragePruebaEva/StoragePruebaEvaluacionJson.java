...
public class StoragePruebaEvaluacionJson implements IStoragePruebas{
    ...
    private final String alumnosFile = dir + File.separator + "pruebas.json";
    ...
    public void save(List<PruebasEvaluacion> item) {
        ...
        try {
            ...
            System.out.println("Pruebas exportados correctamente.");
    ...
    public List<PruebasEvaluacion> load() {
        ...
        try {
            ...
            System.out.println("Pruebas importadas correctamente");
        } catch (Exception e) {
            System.out.println("Error: " + e.getMessage());
        } finally {
            if (reader != null) {
