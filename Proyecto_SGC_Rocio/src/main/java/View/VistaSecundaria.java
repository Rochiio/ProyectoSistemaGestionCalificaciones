...
public class VistaSecundaria {
        ...
        Alumno newStudent;
            try {
                  newStudent = new Alumno(
                        ...
                        Inputs.inputWithRegex("[a-zA-Z]*","Dime el nombre del alumno"),
                        Inputs.inputWithRegex("[a-zA-Z]*[ ][a-zA-Z]*","Dime los apellidos del alumno"),
        ...
        int option = Integer.parseInt(Inputs.inputWithRegex("[0-9]*","Dime el id de la prueba de evaluación a ver"));
            try{
                ...
                if (showTest.isPresent()) {
                    ...
                    System.out.println("Prueba evaluación: " + showTest.get().toStringFormat());
            ...
            int option;
                do {
                    var show = addAlumnsTest(created);
                        ...
                        System.out.println("Calificacion creada: " + show.toStringFormat());
    ...
    public void deleteEvaluation() {
        var deleteTest = Inputs.inputStrings("Introduce la prueba de evaluación a eliminar: ");
            try{
                ...
                System.out.println("Prueba de evaluación eliminada: " + res.toStringFormat());
            } catch (EvaluacionException | SQLException e) {
                System.out.println(e.getMessage());
            }
    }
    ...
    public void showAllEvaluations() {
        try{
            ...
            for (PruebasEvaluacion test: list) {
                System.out.println(test.toStringFormat());
            }
    ...
    public void toMarkdown() {
        textToMarkdown.init(Inputs.inputWithRegex("[a-zA-Z]*","Pon nombre a la carpeta en la que se va a guardar"));
    ...
    public void importJson() {
        //Importamos todos los alumnos .
        var listStudent = storageStudents.load();
        System.out.println("Importados todos los alumnos");
        listStudent.forEach(System.out::println);
        //Importamos todas las categorías .
        var listCategories = storageCategory.load();
        System.out.println("Importadas todas las categorías");
        listCategories.forEach(System.out::println);
        //Importamos todas las pruebas de evaluación
        var listTests = storageTest.load();
        System.out.println("Importadas todas las Pruebas");
        listTests.forEach(System.out::println);
        //Importamos todas las calificaciones
        var listRating = storageRatings.load();
        System.out.println("Importadas todas las calificaciones");
        listRating.forEach(System.out::println);
