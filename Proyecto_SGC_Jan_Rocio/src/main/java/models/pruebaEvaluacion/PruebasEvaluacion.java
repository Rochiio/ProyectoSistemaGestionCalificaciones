...
public class PruebasEvaluacion {
    ...
    public PruebasEvaluacion(Date date, String descripcion, float maximumNote, float minimumNote,
                             float averageGrade, float passPercentages, float failPercentages, CategoriaRepository categoriaRepository,
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id && Float.compare(that.maximumNote, maximumNote) == 0 && Float.compare(that.minimumNote, minimumNote) == 0 && Float.compare(that.averageGrade, averageGrade) == 0 && Float.compare(that.passPercentages, passPercentages) == 0 && Float.compare(that.failPercentages, failPercentages) == 0 && Objects.equals(date, that.date) && Objects.equals(descripcion, that.descripcion) && Objects.equals(categoriaRepository, that.categoriaRepository) && Objects.equals(calificacionRepository, that.calificacionRepository);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, date, descripcion, maximumNote, minimumNote, averageGrade, passPercentages, failPercentages, categoriaRepository, calificacionRepository);
    }
}
